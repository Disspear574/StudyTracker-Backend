...
Прод: `https://studytracker.disspear574.ru/swagger`. Ручной прогон — `http/studytracker.http`.
...
домен `studytracker.disspear574.ru`). Прогон API: `http/studytracker.http`.
